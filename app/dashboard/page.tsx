...
export default function DashboardPage() {
  ...
  const renderUploadCard = (isCentered: boolean = false) => (
    <div className="flex flex-col h-full gap-6">
      <div className={`w-full bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-xl shadow-black/20 flex flex-col ${isCentered ? "max-w-2xl mx-auto" : "flex-grow"}`}>
        {/* Drop Zone */}
        <div
      ...
      {/* Founder's Vision - Placed at the bottom */}
      <div className={`mt-auto bg-gradient-to-br from-indigo-900/30 to-zinc-900/50 border border-indigo-800/30 rounded-xl p-6 ${isCentered ? "max-w-2xl mx-auto w-full" : ""}`}>
  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-grow py-12 px-4 max-w-7xl mx-auto w-full gap-8">
        {/* ROW 1: Header */}
        ...
        {loadingPapers ? (
          <div className="w-full h-full min-h-[400px] flex items-center justify-center bg-zinc-900/20 border border-zinc-800/50 rounded-xl">
            <Loader2 className="w-8 h-8 text-indigo-500 animate-spin" />
          </div>
        ) : !hasData ? (
          /* EMPTY STATE */
          <div className="flex flex-col flex-grow mt-8 gap-8 items-center justify-center w-full">
            {renderUploadCard(true)}
            <div className="w-full max-w-2xl flex flex-col items-center justify-center bg-zinc-900/20 border border-zinc-800/50 border-dashed rounded-xl p-8 text-center mt-4">
          ...
          <div className="flex flex-col gap-8 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-zinc-900/80 to-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 flex flex-col bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg h-full">
                <div className="flex items-center gap-2 mb-6">
                  <BookOpen className="text-cyan-400 w-5 h-5" />
                  <h2 className="text-xl font-bold text-white">Prioritized Study Planner</h2>
                </div>
                <div className="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar flex-1">
                  {sortedTopics.map((topic, index) => (
                    <div
                      key={index}
                      className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-xl bg-zinc-900/80 border border-zinc-800/80 relative overflow-hidden hover:border-indigo-500/30 transition-colors"
                    >
                      <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <TrendingUp className="text-indigo-400 w-5 h-5" />
                  <h3 className="text-xl font-bold text-white">Topic Frequency</h3>
                </div>
                <div className="flex-1 w-full min-h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={analysisData} margin={{ top: 20, right: 0, left: -20, bottom: 60 }}>
                      <XAxis 
                        dataKey="topic" 
              ...
              <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <TrendingUp className="text-indigo-400 w-5 h-5" />
                  <h3 className="text-xl font-bold text-white">Topic Weightage (%)</h3>
                </div>
                <div className="flex-1 w-full min-h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Legend layout="horizontal" verticalAlign="bottom" align="center" wrapperStyle={{ fontSize: '12px', color: '#a1a1aa' }} />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
              </div>
            ...
            {/* ROW 5: The Golden Quadrant Scatter Plot */}
            <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg col-span-1">
              <div className="flex items-center gap-2 mb-2">
                <BarChart2 className="text-fuchsia-400 w-5 h-5" />
                <h3 className="text-xl font-bold text-white">The Golden Quadrant</h3>
              </div>
            ...
            {/* ROW 6: Chat with ExamLens AI */}
            <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-6 shadow-lg flex flex-col h-[500px] col-span-1">
              <div className="flex items-center gap-2 mb-6">
                <MessageSquare className="text-purple-400 w-5 h-5" />
                <h2 className="text-xl font-bold text-white">Chat with ExamLens AI</h2>
              </div>
